  ...
  <section class="membros">
    <div class="row">
      ...
      <div class="col-10" style="background-color:#A68064; padding: 16px; color: aliceblue;">
        ...
        <p>Marcos, desenvolvedor do site MVGames e criador do jogo SwampChalleng, tem 20 anos. Ele é estudante do primeiro período do curso de Tecnologia em Análise e 
    ...
    <div class="row">
      ...
      <div class="col-10" style="background-color: #A68064; padding: 16px; color: aliceblue;">
        ...
        <p>Felipe, desenvolvedor do site ... e criador do jogo ..., tem .. anos. Ele é estudante do primeiro período do curso de Tecnologia em Análise e 
    ...
    <div class="card" style="width: 18rem; border: 5px solid black;">
      <div style="background-color: black;" class="card-body d-flex flex-column align-items-center">
        <a href="index.php?pagina=flappy">
          <img style="border-radius: 16px;" class="w-100" src="img/vinii.png" alt="Marcos Vinicius" title="Marcos Vinicius">
        </a>
